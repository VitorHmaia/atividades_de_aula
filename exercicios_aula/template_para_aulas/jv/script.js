...
//Apagar conteúdo das textareas
var btLimparHtml = document.getElementById('btLimparHtml');
var btLimparJs = document.getElementById('btLimparJs');
btLimparHtml.addEventListener("click", limparConteudoHtml)
btLimparJs.addEventListener("click", limparConteudoJs)
//Funções
function limparConteudoHtml(){
  document.getElementById('textarea_html').value = ''
}
function limparConteudoJs(){
  document.getElementById('textarea_js').value = ''
}
...
btn_blackWhite.addEventListener("click", mudarPorBotao);
//funções
function gerar(){
